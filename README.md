...
| Bodyguard     | Someone who's willing to put their life on the line to save another.                        | Protectee,<br/>Tracking,<br/>This is Fine,<br/>Dodge Roll                           | None      | Keep your protectee alive at any cost.                      |
...
| *Sorcerer*    | A powerful spell-caster bound by an unknown allegiance.                                     | Scatter,<br/>Toadify,<br/>Fog of War,<br/>Vanish,<br/>Spell Book,<br/>Shadow Pledge | None      | Survive to see your secret allegiance win the game.         |
...
| Rescue        | If a player (other than the medic themselves), would otherwise die within 8 blocks of the medic, they will be placed at 0.5 hearts and receive Regeneration III for 15 seconds.                                   | Once every 3 in-game days.             |
